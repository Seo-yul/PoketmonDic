...
public class PoketmonAdminUI extends JFrame implements ActionListener {
	...
	public PoketmonAdminUI() {
		...
		panel_13 = new JPanel();
		panel_13.setBackground(new Color(46, 139, 87));
		...
		lblNewLabel_19 = new JLabel("일본어_이름");
		lblNewLabel_19.setForeground(new Color(25, 25, 112));
		lblNewLabel_19.setFont(new Font("굴림", Font.PLAIN, 18));
		lblNewLabel_19.setHorizontalTextPosition(SwingConstants.CENTER);
		lblNewLabel_19.setHorizontalAlignment(SwingConstants.CENTER);
		panel_13.add(lblNewLabel_19);
		
		panel_14 = new JPanel();
		panel_14.setBackground(new Color(46, 139, 87));
		panel_6.add(panel_14);
		panel_14.setLayout(new BorderLayout(0, 0));
		
		lblNewLabel_20 = new JLabel("No. 000");
		lblNewLabel_20.setHorizontalTextPosition(SwingConstants.CENTER);
		lblNewLabel_20.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_20.setFont(new Font("굴림", Font.BOLD, 25));
		panel_14.add(lblNewLabel_20);
		
		panel_7 = new JPanel();
		panel_7.setBackground(new Color(46, 139, 87));
		...
		panel_8.setBackground(new Color(60, 179, 113));
		panel_8.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		panel_3.add(panel_8);
		...
		lblNewLabel.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		panel_8.add(lblNewLabel);
		
		lblNewLabel_1 = new JLabel("몸무게");
		lblNewLabel_1.setHorizontalTextPosition(SwingConstants.CENTER);
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		panel_8.add(lblNewLabel_1);
		
		
		lblNewLabel_2 = new JTextField();
		lblNewLabel_2.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_2.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		...
		lblNewLabel_3.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		lblNewLabel_3.setBackground(new Color(60, 179, 113));
		lblNewLabel_3.setColumns(10);
		panel_8.add(lblNewLabel_3);
		
		panel_9 = new JPanel();
		panel_9.setBackground(new Color(60, 179, 113));
		panel_9.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		panel_3.add(panel_9);
		...
		lblNewLabel_4.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		panel_9.add(lblNewLabel_4);
		
		lblNewLabel_5 = new JLabel("성비");
		lblNewLabel_5.setHorizontalTextPosition(SwingConstants.CENTER);
		lblNewLabel_5.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_5.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		panel_9.add(lblNewLabel_5);
		
		lblNewLabel_6 = new JTextField();
		lblNewLabel_6.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_6.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		lblNewLabel_6.setBackground(new Color(60, 179, 113));
		lblNewLabel_6.setColumns(10);
		panel_9.add(lblNewLabel_6);
		
		lblNewLabel_7 = new JTextField();
		lblNewLabel_7.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_7.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		lblNewLabel_7.setBackground(new Color(60, 179, 113));
		lblNewLabel_7.setColumns(10);
		panel_9.add(lblNewLabel_7);
		
		panel_10 = new JPanel();
		panel_10.setBackground(new Color(60, 179, 113));
		panel_10.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		...
		lblNewLabel_8.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		...
		lblNewLabel_9.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		panel_10.add(lblNewLabel_9);
		
		lblNewLabel_10 = new JTextField();
		lblNewLabel_10.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_10.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		lblNewLabel_10.setBackground(new Color(60, 179, 113));
		lblNewLabel_10.setColumns(10);
		panel_10.add(lblNewLabel_10);
		
		lblNewLabel_11 = new JTextField();
		lblNewLabel_11.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_11.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		lblNewLabel_11.setBackground(new Color(60, 179, 113));
		lblNewLabel_11.setColumns(10);
		panel_10.add(lblNewLabel_11);
		
		panel_11 = new JPanel();
		panel_11.setBackground(new Color(60, 179, 113));
		panel_11.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		...
		lblNewLabel_12.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		...
		lblNewLabel_13.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		panel_11.add(lblNewLabel_13);
		
		lblNewLabel_14 = new JTextField();
		lblNewLabel_14.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_14.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		lblNewLabel_14.setBackground(new Color(60, 179, 113));
		lblNewLabel_14.setColumns(10);
		panel_11.add(lblNewLabel_14);
		
		lblNewLabel_15 = new JTextField();
		lblNewLabel_15.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_15.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		lblNewLabel_15.setBackground(new Color(60, 179, 113));
		lblNewLabel_15.setColumns(10);
		panel_11.add(lblNewLabel_15);
		
		panel_12 = new JPanel();
		panel_12.setBackground(new Color(60, 179, 113));
		panel_12.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		...
		lblNewLabel_16.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		panel_12.add(lblNewLabel_16);
		
		lblNewLabel_17 = new JTextField();
		lblNewLabel_17.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_17.setBorder(new LineBorder(new Color(0, 128, 0), 1, true));
		lblNewLabel_17.setBackground(new Color(60, 179, 113));
